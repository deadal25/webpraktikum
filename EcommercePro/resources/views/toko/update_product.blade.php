    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="div_center">
                ...
                <form action="{{ url('updateproduct', $data->id) }}" method="POST" enctype="multipart/form-data" class="mx-auto" style="width: 50%;">
                    @csrf
                    <div class="div_design">
                        <label for="title" class="text_color">Product Title</label>
                        <input class="form-control" type="text" name="title" placeholder="Write a Title" required="" value="{{ $data->title }}">
                    </div>
                    <div class="div_design">
                        <label for="description" class="text_color">Product Description</label>
                        <input class="form-control" type="text" name="description" placeholder="Write a Description" required="" value="{{ $data->description }}">
                    </div>
                    <div class="div_design">
                        <label for="price" class="text_color">Product Price</label>
                        <input class="form-control" type="number" name="price" placeholder="Write a Price" required="" value="{{ $data->price }}">
                    </div>
                    <div class="div_design">
                        <label for="discount_price" class="text_color">Discount Price</label>
                        <input class="form-control" type="number" name="discount_price" placeholder="Write a Discount Price" required=""  value="{{ $data->discount_price }}">
                    </div>
                    <div class="div_design">
                        <label for="quantity" class="text_color">Product Quantity</label>
                        <input class="form-control" type="number" min="0" name="quantity" placeholder="Write a Quantity" required="" value="{{ $data->quantity }}">
                    </div>
                    <div class="div_design">
                        <label for="store_id" >ID toko</label>
                        <input class="text_color" type="number" min="0" name="store_id" placeholder="Write a store" required="" value="{{ $data->store_id }}">
                    </div>
                    <div class="div_design">
